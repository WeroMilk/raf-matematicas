...
export default function EscuelasContent({ escuelas }: Props) {
  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col gap-2 p-2 pb-2">
      ...
      <ul className="grid min-h-0 flex-1 grid-cols-2 gap-2 overflow-auto sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 content-start">
        {sorted.map(({ escuela: e, nivel }, i) => {
          ...
          return (
            ...
            >
              ...
              >
                <span className="truncate w-full text-xs font-semibold leading-tight">{e.cct}</span>
                <span
